                ...
                <div className="container-fluid">
                    <div className="row align-items-end mb-5">
                        <div className="col-lg-6">
                            ...
                            <h2 className="spb-intro__heading">Real SEO Results<br />for Real Businesses</h2>
                        </div>
                        <div className="col-lg-6">
                            <p className="sec-p">Numbers don't lie. Here's what our SEO strategies have delivered for businesses across industries — measurable rankings, traffic, and revenue growth.</p>
                        </div>
                    </div>
                    <div className="row g-4">
            ...
            <section className="dark-sec">
                <div className="spb-container container-fluid">
                    <div className="row align-items-end mb-2">
                        ...
                        <div className="col-lg-6">
                            <p className="sec-p">We don't chase vanity metrics. Every SEO strategy we build is tied to real business outcomes — traffic, leads, and revenue that justify every rupee invested.</p>
                        </div>
                    </div>
                    <div className="row g-4">
                        {data.whyUs.map((w, i) => (
                    ...
                    <div className="row g-5">
                        ...
                        <div className="col-7">
                            <div className="text-center mb-2">
                                ...
                                <h2 className="spb-intro__heading">SEO Questions Answered</h2>
                            </div>
